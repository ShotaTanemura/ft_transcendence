...
export class PongGameTournamentBracket extends Component {
  ...
  createTounamentObject(tournament) {
    let parentElement = Object.assign(document.createElement("div"), {
      className: `bracket`,
    });
    tournament.map((round, roundIndex) => {
      let roundElement = Object.assign(document.createElement("section"), {
      ...
      round.map((game, gameIndex) => {
        if (gameIndex % 2 === 0) {
          matchesElement = Object.assign(document.createElement("div"), {
            className: "matches",
          });
          matchupsElement = Object.assign(document.createElement("div"), {
            className: "matchups",
          });
          matchesElement.appendChild(matchupsElement);
        }
        let matchupElement = Object.assign(document.createElement("div"), {
          className: "matchup",
        });
        let participantsElement = Object.assign(document.createElement("div"), {
        ...
        if (gameIndex % 2 === 1) {
          let connectorElement = Object.assign(document.createElement("div"), {
            className: "connector",
          });
